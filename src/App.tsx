...
function App() {
  ...
  return (
    <FormProvider {...methods}>
      <div
        className="d-block d-md-grid h-75"
      ...
      >
        <Container style={{ maxWidth: '968px' }} className="h-75">
          <Row className=" bg-white rounded-3 p3 h-100">
            <Col md="4" style={{ minHeight: '568px' }} className="p-md-3 p-0">
              <ul
            ...
            <Col className="p-md-5 m-3 d-flex rounded-md-3 rounded-0 flex-column ">
              <Stepper step={step} />
              <div className="hstack justify-content-between mt-auto">
